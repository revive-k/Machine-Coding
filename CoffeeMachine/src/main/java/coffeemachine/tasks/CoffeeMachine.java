...
import coffeemachine.inventory.InventoryManager;
import coffeemachine.model.Beverage;
import coffeemachine.model.CoffeeMachineDetails;
...
public class CoffeeMachine {
     ...
     * will return CoffeeMachine.INSTANCE if it already exits else creates one
     * @return
     * @throws IOException
     */
